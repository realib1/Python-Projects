...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    if reactor_efficiency_percentage < 30:
        return "black"
    elif reactor_efficiency_percentage >= 30 and reactor_efficiency_percentage < 60:
        return "red"
    elif reactor_efficiency_percentage >= 60 and reactor_efficiency_percentage < 80:
        return "orange"
    elif reactor_efficiency_percentage >= 80:
        return "green"
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if value < lower:
        ...
        return "DANGER"
    elif lower <= value and value <= upper:
        return "NORMAL"

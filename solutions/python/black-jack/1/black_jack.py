...
def higher_card(card_one, card_two):
    ...
    Returns:
        str or tuple: The resulting tuple contains both cards if they are of
        equal value.
    """
...
def can_split_pairs(card_one, card_two):
    ...
    Returns:
         bool: Can the hand be split into two pairs? (i.e. cards are of
         the same value).
    """
...
def can_double_down(card_one, card_two):
    ...
    Returns:
        bool: Can the hand can be doubled down?
...
print(higher_card("10", "J"))
print(higher_card("3", "A"))

print("\n --- Ace ---")
print(f"Ace = {value_of_ace('2', 'A')}")
print(f"Ace = {value_of_ace('5', '5')}")
